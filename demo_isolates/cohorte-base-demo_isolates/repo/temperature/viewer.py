...
@ComponentFactory("org.cohorte.demo.isolates.temperature.Viewer")
...
class Viewer(object):
    ...
    def do_GET(self, request, response):
        ...
        result = """
        <img src="http://cohorte.github.io/resources/images/cohorte-logo.png">
        <H3>Actual Temperature : {0}</h3>
        """.format(temp)
